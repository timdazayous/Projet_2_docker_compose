...
* 📚 **Documentation Technique (Sphinx)** : [https://timdazayous.github.io/Projet_2_docker_compose/](https://timdazayous.github.io/Projet_2_docker_compose/)
...
La documentation est générée automatiquement à chaque push et hébergée sur GitHub Pages.

*   **Lien Public** : [https://timdazayous.github.io/Projet_2_docker_compose/](https://timdazayous.github.io/Projet_2_docker_compose/)
*   **Accès local (si API lancée)** : [http://localhost:8000/docs/static/index.html](http://localhost:8000/docs/static/index.html)
